...
from mi.dataset.driver.dosta_ln.wfp.driver import DostaLnWfp
from mi.dataset.parser.dosta_ln_wfp import DostaLnWfpParserDataParticle

# Fill in driver details
DataSetTestCase.initialize(
    driver_module='mi.dataset.driver.dosta_ln.wfp.driver',
    driver_class='DostaLnWfp',
    agent_resource_id = '123xyz',
    agent_name = 'Agent007',
    agent_packet_config = DostaLnWfp.stream_config(),
    startup_config = {
