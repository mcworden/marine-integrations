...
from mi.dataset.driver.wfp_eng.wfp_sio_mule.driver import WfpEngWfp
from mi.dataset.parser.wfp_eng_wfp_sio_mule import WfpEngWfpSioMuleParserDataParticle

# Fill in driver details
DataSetTestCase.initialize(
    driver_module='mi.dataset.driver.wfp_eng.wfp_sio_mule.driver',
    driver_class='WfpEngWfp',
    agent_resource_id = '123xyz',
    agent_name = 'Agent007',
    agent_packet_config = WfpEngWfp.stream_config(),
    startup_config = {
        DataSourceConfigKey.RESOURCE_ID: 'wfp_eng_wfp_sio_mule',
...
SAMPLE_STREAM = 'wfp_eng_wfp_sio_mule_parsed'
